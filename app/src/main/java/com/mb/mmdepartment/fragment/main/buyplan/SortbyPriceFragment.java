...
public class SortbyPriceFragment extends Fragment implements RequestListener {
    private static final String TAG = SortbyPriceFragment.class.getSimpleName();
    private SortBiz biz;
    ...
    public static SortbyPriceFragment newInstance(String param1, String param2) {
        SortbyPriceFragment fragment = new SortbyPriceFragment();
        Bundle args = new Bundle();
        return fragment;
    }

    public SortbyPriceFragment() {
    ...
    public void  setBundle(Bundle bundle){
        this.bundle2 = bundle;
        group = bundle2.getInt("group");
        int order = bundle2.getInt("order");
...
//                    biz.sort(TAG, JPushInterface.getRegistrationID(getActivity()), order_type,category, shop_id,  group, 50, order, this);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        buy_plan_recycle.setOnGroupClickListener(new ExpandableListView.OnGroupClickListener() {
            @Override
