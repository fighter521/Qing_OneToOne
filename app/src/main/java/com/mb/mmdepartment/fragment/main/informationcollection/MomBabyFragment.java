 ...
 */
public class MomBabyFragment extends Fragment implements RequestListener,AccumulateShopItemClickListener {
    ...
    private Handler handler=new Handler(){
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what){
                ...
                case 2:
                    Log.e("error","网络请求失败");
//                            ((InfomationSummaryActivity) getActivity()).showToast("网络请求失败");
                    break;
            }
