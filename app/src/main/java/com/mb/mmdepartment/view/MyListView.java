...
/**
 * Created by krisi on 2015/10/24.
 */
public class MyListView extends ListView implements AbsListView.OnScrollListener{
    ...
    private LinearLayout mRefreshHeaderView2;              // 头视图(也就是头部那部分)
...
//    private TextView mRefreshViewLastUpdated;               // 最近更新的文本
    ...
    private void init(Context context) {
        ...
        // 加载下拉刷新的头部视图
        mRefreshHeaderView = (LinearLayout)findViewById(R.id.main_function_recyc);
        mRefreshHeaderView2 = (LinearLayout)findViewById(R.id.main_fragment_bar);
//        mRefreshViewText =
...
//        mRefreshViewImage.setMinimumHeight(50);     // 设置图片最小高度
        ...
        addHeaderView(mRefreshHeaderView2);
    ...
    public interface OnRefreshListener {
         ...
         * 当列表应当被刷新是调用这个方法
         * <p>
         * A call to {@link MyListView #onRefreshComplete()} is
